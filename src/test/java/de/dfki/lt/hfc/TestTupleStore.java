...
public class TestTupleStore {
	...
	public void testConstructors() {
		...
		//constructor TupleStore(int noOfAtoms, int noOfTuples, ns, filename) is tested
		TupleStore tupleconstructor3 = new TupleStore(100000, 250000, namespace, "D:/DFKI/hfc/src/main/resources/default.nt");
		assertNotNull(tupleconstructor3);
		//constructor TupleStore(int noOfAtoms, int noOfTuples, Namespace namespace) is tested
	...
	public void testprintTuple(){
		...
		//I refactored the method in the class. Return String, not void. Form the string, then return it.
		assertEquals(TupleStore.printTuple(tuple, mapping), "a b c .");
	}
	@Test
	...
	public void testputObject(){
		...
		assertFalse("Compare the returned id with zero", objecttotest.putObject("www.bbc.com") == 0);
		assertEquals(objecttotest.putObject("www.bbc.com"), 6);
	}
	@Test
	public void testgetObject(){
		TupleStore objectfortest = new TupleStore(2, 10);
		objectfortest.putObject("www.bbc.com");
		assertFalse(objectfortest.getObject(5) == null);
		assertEquals(objectfortest.getObject(6), "www.bbc.com");
		assertFalse(objectfortest.putObject("?") == 0);
		assertEquals(objectfortest.getObject(7), "?");
		assertEquals(objectfortest.getObject(-100), "?-100");
	}
	@Test
	...
	public void testisValidTuple(){
		...
		Namespace namespace = new Namespace("D:/DFKI/hfc/src/main/resources/default.ns");
		TupleStore objecToTestRdfTrue = new TupleStore(true, true, true, 2, 5, 4, 2, namespace, "D:/DFKI/hfc/src/main/resources/default.nt");
	...
	public void testgetTuples1(){
		...
		Namespace namespace = new Namespace("D:/DFKI/hfc/src/main/resources/default.ns");
		TupleStore objectfull = new TupleStore(namespace, "D:/DFKI/hfc/src/main/resources/default.nt");
	...
	public void testwriteTuples2(){
		...
		Namespace namespace = new Namespace("D:/DFKI/hfc/src/main/resources/default.ns");
		TupleStore tupleconstructor5 = new TupleStore(true, false, true, 2, 5, 4, 2, namespace, "D:/DFKI/hfc/src/main/resources/default.nt");
	...
	public void testwriteTupleStore(){
		...
		//verbose = false
		Namespace namespace = new Namespace("D:/DFKI/hfc/src/main/resources/default.ns");
		TupleStore objectverbosefalse = new TupleStore(true, false, true, 2, 5, 4, 2, namespace, "D:/DFKI/hfc/src/main/resources/default.nt");
	...
	public void testcontainsPrefixPattern(){
		...
		//System.out.println("PREFIX " + objectfortest.containsPrefixPattern(prefixPattern));
	}
	@Test
	...
	public void testcopyTupleStore(){
		Namespace namespace = new Namespace("D:/DFKI/hfc/src/main/resources/default.ns");
		TupleStore objectfortest = new TupleStore(true, true, true, 2, 5, 4, 2, namespace, "D:/DFKI/hfc/src/main/resources/default.nt");
