...
public final class FProductTest {
  ...
  public void testcleanUpTuple() throws FileNotFoundException,
    ...
    FunctionalOperator fop =
        ...
        .checkAndRegister("de.dfki.lt.hfc.operators.FProduct");
    ...
    assertEquals(FunctionalOperator.TRUE, feq.apply(t_ids), "100.0 * 80.0 = 8000.0");
    f_nids[1] = fop.apply(nids);
    assertEquals(FunctionalOperator.FALSE, feq.apply(f_nids),"100.0 * 70.0 != 8000.0");
  }
}
