...
public class ISumTwoTest {
  ...
  public static void init() throws Exception {
    ...
    fc =  new Hfc(Config.getInstance(getResource("ISum2.yml")));
  ...
  public void test() throws QueryParseException  {
    ...
    String[][] expected = {
        ...
        { "_:de.dfki.lt.hfc.Hfc@45283ce24", "<test:numberOfEmployees>", "\"61000\"^^<xsd:int>" },
        ...
        { "_:de.dfki.lt.hfc.Hfc@45283ce22", "<test:numberOfEmployees>", "\"60500\"^^<xsd:int>" },
        ...
        { "_:de.dfki.lt.hfc.Hfc@45283ce25", "<test:numberOfEmployees>", "\"60500\"^^<xsd:int>" },
        { "_:de.dfki.lt.hfc.Hfc@45283ce21", "<test:numberOfEmployees>", "\"1500\"^^<xsd:int>" },
        { "<owl:Nothing>", "<rdf:type>", "<owl:Class>" },
        { "_:de.dfki.lt.hfc.Hfc@45283ce23", "<test:numberOfEmployees>", "\"1500\"^^<xsd:int>" },
        { "<test:sri>", "<test:hasName>", "\"Stanford Research Institute\"^^<xsd:string>" },
        { "<test:dfki>", "<rdf:type>", "<test:Company>" },
        { "_:de.dfki.lt.hfc.Hfc@45283ce20", "<test:numberOfEmployees>", "\"61000\"^^<xsd:int>" },
