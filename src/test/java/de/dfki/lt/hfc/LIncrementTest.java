...
public final class LIncrementTest {
  ...
  public void testcleanUpTuple() throws FileNotFoundException,
    ...
    FunctionalOperator fop =
        ...
        .checkAndRegister("de.dfki.lt.hfc.operators.LIncrement");
    ...
    // do operation
    ids[0] = fop.apply(ids);
    assertEquals( FunctionalOperator.TRUE, feq.apply(ids),"1++ = 2");
    nids[0] = fop.apply(nids);
    assertEquals( FunctionalOperator.FALSE, feq.apply(nids),"9++ != 7");
  }
}
