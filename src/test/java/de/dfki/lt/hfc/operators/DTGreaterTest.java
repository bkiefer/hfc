...
public class DTGreaterTest {
 ...
 public void apply() throws FileNotFoundException,
  ...
  FunctionalOperator fop =
          (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.DTGreater");
  ...
  assertEquals("0002-00-00T00:00:01.0", FunctionalOperator.FALSE, fop.apply(new int[]{args[0], args[0]}));
