...
public class DTDecrementTest {
 ...
 public void apply() throws FileNotFoundException,
  ...
  FunctionalOperator fop =
          (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.DTDecrement");
  ...
  // do operation
  assertEquals("0001-12-30T23:59:59.0", store.getObject(fop.apply(new int[]{args[0]})).toName());
  assertEquals("0003-12-30T23:59:59.0", store.getObject(fop.apply(new int[]{args[1]})).toName());
 }
}