...
public class IsNotSubtypeOfTest {
  ...
  @Test
  public void testNoSubTypeOf() throws FileNotFoundException,
    ...
    FunctionalOperator fop =
            (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.IsNotSubtypeOf");


    // do operation
    assertEquals("Valid Tuple: <rdf:type> <rdf:type> <rdf:Property>", FunctionalOperator.FALSE, fop.apply(validArgs));
