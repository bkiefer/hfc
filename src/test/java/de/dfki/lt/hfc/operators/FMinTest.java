...
public final class FMinTest {

  @Test
  public void testFMin() throws FileNotFoundException,
    ...
    FunctionalOperator fop =
        (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.FMin");
