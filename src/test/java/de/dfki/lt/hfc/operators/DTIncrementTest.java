...
public class DTIncrementTest {
 ...
 public void apply() throws FileNotFoundException,
  ...
  FunctionalOperator fop =
          (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.DTIncrement");
  ...
  // do operation
  assertEquals("0002-00-00T00:00:01.0", store.getObject(fop.apply(new int[]{args[0]})).toName());
  assertEquals("0004-00-00T00:00:01.0", store.getObject(fop.apply(new int[]{args[1]})).toName());
 }
}