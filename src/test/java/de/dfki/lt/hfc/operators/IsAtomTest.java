 ...
 */
public final class IsAtomTest {

  @Test
  public void testIsAtom() throws FileNotFoundException,
    ...
    FunctionalOperator fop =
        (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.IsAtom");
