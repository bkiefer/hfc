...
public class DaDecrementTest {
 ...
 public void apply() throws FileNotFoundException,
  ...
  FunctionalOperator fop =
          (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.DaDecrement");
  ...
  // do operation
  assertEquals("0001-12-30", store.getObject(fop.apply(new int[]{args[0]})).toName());
  assertEquals("0003-12-30", store.getObject(fop.apply(new int[]{args[1]})).toName());
