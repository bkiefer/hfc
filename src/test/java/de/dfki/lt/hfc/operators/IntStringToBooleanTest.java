...
public final class IntStringToBooleanTest {
  ...
  @Test
  public void testIntStringToBoolean() throws FileNotFoundException,
    ...
    FunctionalOperator fop =
        (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.IntStringToBoolean");
