...
public class DIncrementTest {

 @Test
 public void testDIncrement() throws FileNotFoundException,
  ...
  FunctionalOperator fop =
          (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.DIncrement");
  ...
  // do operation
  assertEquals("0.1", store.getObject(fop.apply(new int[]{args[0]})).toName());
  assertEquals("1.0000000000000002", store.getObject(fop.apply(new int[]{args[1]})).toName());
 }
}