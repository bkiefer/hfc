...
public class DTGreaterEqualTest {
 ...
 public void apply() throws FileNotFoundException,
  ...
  FunctionalOperator fop =
          (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.DTGreaterEqual");
  ...
  // do operation
  assertEquals("0002-00-00T00:00:01.0", FunctionalOperator.FALSE, fop.apply(new int[]{args[0], args[1]}));
  assertEquals("0002-00-00T00:00:01.0", FunctionalOperator.TRUE, fop.apply(new int[]{args[0], args[0]}));
  assertEquals("0002-00-00T00:00:01.0", FunctionalOperator.TRUE, fop.apply(new int[]{args[1], args[0]}));
