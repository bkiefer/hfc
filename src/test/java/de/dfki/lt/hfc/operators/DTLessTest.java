 ...
 */
public final class DTLessTest {

  @Test
  public void testDTLess() throws FileNotFoundException,
    ...
    FunctionalOperator fop =
        (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.DTLess");
    ...
    assertEquals(FunctionalOperator.FALSE, fop.apply(new int[] {dates[3], dates[4]}));
  }
}
