...
public final class LNotEqualTest {

  @Test
  public void testLNotEqual() throws FileNotFoundException,
    ...
    FunctionalOperator fop =
        (FunctionalOperator)store.checkAndRegisterOperator("de.dfki.lt.hfc.operators.LNotEqual");
