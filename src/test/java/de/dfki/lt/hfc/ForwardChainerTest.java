...
fc.shutdown();*/
	...
	public void testForwardChainer6(){
		...
		RuleStore ruleStore = new RuleStore(namespace, tupleStore);
		ForwardChainer fc = new ForwardChainer(noOfCores, verboseT, noOfAtoms, noOfTuples,
		namespace, tupleStore, ruleStore);
		assertNotNull(fc);
		ForwardChainer fc0 = new ForwardChainer(noOfCores, verboseF, noOfAtoms, noOfTuples,
				namespace, tupleStore, ruleStore);
		assertNotNull(fc0);
	}
	@Test
	...
	public void testcomputeClosure(){
		...
		//
		Namespace namespace = new Namespace("D:/DFKI/hfc/src/main/resources/default.ns");
		TupleStore tupleStore = new TupleStore(true, true, true, 2, 5, 4, 2, namespace, "D:/DFKI/hfc/src/main/resources/default.nt");
		RuleStore ruleStore = new RuleStore(namespace, tupleStore);
		...
		//
		TupleStore tupleStore1 = new TupleStore(true, true, false, 2, 1, 2, 3, namespace, "D:/DFKI/hfc/src/main/resources/default.nt");
	...
	public void testuploadNamespaces(){
		...
		String filename = "D:/DFKI/hfc/src/main/resources/default.ns";
		String tupleFile = "D:/DFKI/hfc/src/main/resources/default.nt";
		String ruleFile = "D:/DFKI/hfc/src/main/resources/default.eqred.rdl";
		ForwardChainer fc = new ForwardChainer(tupleFile, ruleFile);
	...
	public void testuploadTuples(){
		...
		String filename = "D:/DFKI/hfc/src/main/resources/default.nt";
		Namespace namespace = new Namespace("D:/DFKI/hfc/src/main/resources/default.ns");
		TupleStore tupleStore = new TupleStore(1, 2);
		RuleStore ruleStore = new RuleStore(namespace, tupleStore);
		ForwardChainer fc = new ForwardChainer(namespace, tupleStore, ruleStore);
	...
	public void testuploadRules(){
		...
		String filename = "D:/DFKI/hfc/src/main/resources/default.eqred.rdl";
		Namespace namespace = new Namespace("D:/DFKI/hfc/src/main/resources/default.ns");
		TupleStore tupleStore = new TupleStore(1, 2);
		RuleStore ruleStore = new RuleStore(namespace, tupleStore);
		ForwardChainer fc = new ForwardChainer(namespace, tupleStore, ruleStore);
