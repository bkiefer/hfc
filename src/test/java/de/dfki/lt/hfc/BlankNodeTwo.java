...
public class BlankNodeTwo {
  ...
  public void test() throws QueryParseException {
    ...
    for (Object[] p: permuts) {
      ...
      ac1.add(new String[]{  "<test:sri>", "<test:new1>",p[0].toString()});
      ac1.add(new String[]{"<test:sri>", "<test:new2>", p[0].toString()});
      ac1.add(new String[]{"<test:db>", "<test:new2>", p[1].toString()});
      ac1.add(new String[]{  "<test:db>", "<test:new1>",p[1].toString()});
      ac1.add(new String[]{  "<test:dfki>", "<test:new1>",p[2].toString()});
      ac1.add(new String[]{"<test:dfki>", "<test:new2>", p[2].toString()});
