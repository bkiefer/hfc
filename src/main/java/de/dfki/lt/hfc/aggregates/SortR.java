...
/**
 * The Sort aggregate is used to arrange the entries in the given bindingtable in an descending order with respect to
 ...
 */
public class SortR extends AggregationalOperator{
    @Override
