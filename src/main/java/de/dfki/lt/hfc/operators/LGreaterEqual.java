 ...
 */
public final class LGreaterEqual extends FunctionalOperator {
	...
	public int apply(int[] args) {
		return ((XsdLong)getObject(args[0])).value >= ((XsdLong)getObject(args[1])).value ? FunctionalOperator.TRUE : FunctionalOperator.FALSE;
	}
