...
public final class TupleStore {
  ...
  */
 private OperatorRegistry operatorRegistry = new OperatorRegistry(this);
...
//        this.idToObject = new ArrayList<AnyType>(noOfAtoms);
 ...
 public Operator checkAndRegisterOperator(String className) {
  ...
  public BindingTable[] evaluateRelOperator(String name, String operatorPath, BindingTable[] args) {
   return  operatorRegistry.evaluate(name,operatorPath,args);
 }
}
